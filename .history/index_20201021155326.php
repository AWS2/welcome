	...
	<?php 
		...
		foreach( $imgs as $img ) {	
			if( substr($img,-3)=="jpg" or substr($img,-3)=="png" or substr($img,-4)=="jpeg") {
				$name = substr($img,0,-4);
				echo "
					<div class='card' style='width: 18rem; display:flex; float: left; padding: px;'>
						<img class='card-img-top' src='img/$img' alt='Card image cap' style='height: 270px; width: 270px;'>
