...
<body style="height:100%; padding: 5% 10%">
	...
	<?php 
		...
		foreach( $imgs as $img ) {	
			if( substr($img,-3)=="jpg" or substr($img,-3)=="png" or substr($img,-4)=="jpeg") {
				$name = substr($img,0,-4);
				echo "
					<div class='card' style='width: 18rem; display:flex; float: left; padding: 5px;'>
						<img class='card-img-top' src='img/$img' alt='Card image cap' style='height: 200px; width: 200px;'>
